...
This is a sample template for danmu-server - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name danmu-server --query 'Stacks[].Outputs'
```
